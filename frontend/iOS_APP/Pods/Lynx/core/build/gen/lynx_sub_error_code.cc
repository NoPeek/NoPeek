...
namespace error {
	...
	// Behavior: LifecycleListenerError
	// Description: Error occurred while calling RuntimeLifecycleListener.
	// BehaviorCode: 203

	// Calling RuntimeLifecycleListener has error.
	const int32_t E_BTS_LIFECYCLE_LISTENER_ERROR_EXCEPTION = 20301;
	...
	const int32_t E_NATIVE_MODULES_COMMON_DEPRECATED = 90108;
